...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES ('OPPONENT_MELEE_ANTICAV_LIGHTCAV_REQUIREMENTS_MUU', 'ANTI_CAVALRY_OPPONENT_REQUIREMENT_LC');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES ('OPPONENT_MELEE_ANTICAV_LIGHTCAV_REQUIREMENTS_MUU', 'ANTI_SPEAR_OPPONENT_REQUIREMENT');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES ('OPPONENT_MELEE_ANTICAV_LIGHTCAV_REQUIREMENTS_MUU', 'OPPONENT_MELEE_REQUIREMENT');
...
--INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES ('ABILITY_INDONESIAN_KRIS_SWORDSMAN', '?');
--INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES ('ABILITY_MONGOLIAN_HUI_HUI_PAO', '?');
...
-- Gunpowder Melee
INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_AMERICAN_MINUTEMAN', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_AMERICAN_MINUTEMAN');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_FRENCH_MARINE', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_FRENCH_MARINE');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_GREEK_ARMATOLOS', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_GREEK_ARMATOLOS');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_INDIAN_SEPOY', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_INDIAN_SEPOY');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_KONGO_GARDE_REPUBLICAINE', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_KONGO_GARDE_REPUBLICAINE');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_AUSTRALIAN_SASR', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_AUSTRALIAN_SASR');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_POLISH_CHOSEN_INFANTRY', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_POLISH_CHOSEN_INFANTRY');

INSERT INTO TypeTags (Type, Tag) SELECT ('UNIT_DUTCH_SCHUTTERIJ', 'CLASS_GUNPOWDER_MELEE')
WHERE EXISTS (SELECT 1 FROM TypeTags WHERE Tag = 'CLASS_GUNPOWDER_MELEE')
AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_DUTCH_SCHUTTERIJ');
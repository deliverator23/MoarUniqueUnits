...
INSERT INTO Units (UnitType, Cost, Maintenance, BaseMoves, BaseSightRange, ZoneOfControl, Domain, Combat, FormationClass, PromotionClass, AdvisorType, Name, Description, PurchaseYield, MandatoryObsoleteTech, PrereqTech, TraitType)
SELECT Type, '180', '3', '2', '2', 1, 'DOMAIN_LAND', '41', 'FORMATION_CLASS_LAND_COMBAT', 'PROMOTION_CLASS_ANTI_CAVALRY', 'ADVISOR_CONQUEST', 'LOC_UNIT_MAPUCHE_GUERILLA_NAME', 'LOC_UNIT_MAPUCHE_GUERILLA_DESCRIPTION', 'YIELD_GOLD', 'TECH_COMPOSITES', 'TECH_MILITARY_TACTICS', 'TRAIT_CIVILIZATION_UNIT_MAPUCHE_GUERILLA'
...
--INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES ('ABILITY_ZULU_ASSEGAI', '?');
